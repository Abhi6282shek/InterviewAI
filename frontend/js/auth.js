    ...
    renderNavBar() {
        ...
        if (isLoggedIn) {
            navLinksHTML += `
                ...
                <li><a href="mixed-arena.html" class="nav-link" id="nav-mixed">Mixed Loop</a></li>
                <li><a href="company.html" class="nav-link" id="nav-company">Company Mode</a></li>
                <li><a href="voice-interview.html" class="nav-link" id="nav-voice">Voice Agent</a></li>
                <li><a href="ide.html" class="nav-link" id="nav-ide">Coding IDE</a></li>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Dynamically inject global chatbot assistant
    if (Auth.isAuthenticated()) {
        const cssLink = document.createElement('link');
        cssLink.rel = 'stylesheet';
        cssLink.href = 'css/assistant.css';
        document.head.appendChild(cssLink);

        const jsScript = document.createElement('script');
        jsScript.src = 'js/assistant.js';
